...
type Transaction struct {
	...
	DiscountPercentage float64                    `bson:"discount_percentage" json:"discountPercentage"`
	InterestPercentage float64                    `bson:"interest_percentage" json:"interestPercentage"`
}
