...
type TransactionBalance struct {
	...
	Parts    int `bson:"parts" json:"parts,omitempty"`       // increase
	Labor    int `bson:"labor" json:"labor,omitempty"`       // increase
	Discount int `bson:"discount" json:"discount,omitempty"` // decrease
	Interest int `bson:"interest" json:"interest,omitempty"` // increase
}
